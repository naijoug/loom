...
> 2026-08-05 稳定化复验：前端/领域测试已增至 88/88，Rust 仍为 166/166（另 1 项真实凭据测试忽略）；生产最大 chunk 为 394.72KB / gzip 103.33KB；重新生成的 arm64 DMG SHA-256 为 `6d50004e0679cf77d9a3fcba11c4683fc2a52f8abfc5d07ab934e0c8a95de931`。原表保留 2026-07-24 当日历史结果。
